...
const HomePage = () => {
  ...
  let displayTasksPage = window.location.pathname === "/chores"; // Determine if the user is on the chores page

  // Get the user's chores
  const { isLoading: isTasksLoading, data: choresData } = useQuery(
    "chores",
      ...
      <>
        ...
        <div id="header">
          ...
          <div id="navButtons">
            <Button
              id="toSchedulePage"
              className={displayTasksPage ? "" : "currPage"}
              onClick={() => {
          ...
          <div>
            ...
            >
              <span className="pi pi-plus"></span>&nbsp;Task
            </Button>
        ...
        {displayTasksPage ? (
          <TasksPage isTasksLoading={false} choresData={choresData} />
        ) : (
          <SchedulePage
